...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChatindexPageModule", function() { return ChatindexPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__chatindex__ = __webpack_require__(290);
...
var ChatindexPageModule = /** @class */ (function () {
    function ChatindexPageModule() {
    }
    ChatindexPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__chatindex__["a" /* ChatindexPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__chatindex__["a" /* ChatindexPage */]),
            ],
        })
    ], ChatindexPageModule);
    return ChatindexPageModule;
}());

//# sourceMappingURL=chatindex.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ChatindexPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_commonutils_commonutils__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__angular_animations__ = __webpack_require__(291);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_css_animator__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_native_page_transitions__ = __webpack_require__(201);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChatindexPage = /** @class */ (function () {
    function ChatindexPage(navCtrl, utils, navParams, animationService, nativePageTransitions) {
     ...
     */
    ChatindexPage.prototype.ionViewCanEnter = function () {
        var _this = this;
        this.utils.getUserData().then(function (data) {
            _this.userData = data;
        });
    };
    ChatindexPage.prototype.animateElem = function (items) {
     ...
     * @param itemValue
     */
    ChatindexPage.prototype.navigateChatDetails = function (itemValue) {
    ...
    ], ChatindexPage.prototype, "myElem", void 0);
    ChatindexPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-chatindex',template:/*ion-inline-start:"E:\Animation Project\SimpleChatBot24\SimpleChatBot24\src\pages\chatindex\chatindex.html"*/'<ion-header>\n  <ion-navbar>\n    <button start ion-button color="primary" clear icon-only menuToggle>\n      <ion-icon name="md-list"></ion-icon>\n      <!-- <img style="width:12%;" src="assets/imgs/sidemenu.png"> -->\n    </button>\n    <div class="docsBgTitle" style="width: 50%; position: absolute; top: 25%;left: 25%;">\n      <ion-title text-center>Chats</ion-title>\n    </div>\n    <div class="docsBgIcon">\n      <ion-buttons end>\n        <button ion-button color="primary" clear icon-only>\n          <ion-icon name="person"></ion-icon>\n        </button>\n      </ion-buttons>\n    </div>\n  </ion-navbar>\n</ion-header>\n<ion-content class="docsBgContent">\n  <ion-list no-lines >\n  <!-- <button ion-button (click)="animateElem()">Click Me!</button> -->\n  <!-- <ion-card #myElement>\n    <ion-card-header>\n      Good Afternoon\n    </ion-card-header>\n    <ion-card-content>\n      How are you?\n    </ion-card-content>\n  </ion-card>  -->\n\n    <ion-item class="menuWrapper" *ngFor="let items of userData;let i = index;" (tap)="navigateChatDetails(items)">\n      <ion-avatar item-start>\n        <img src={{items.image}}>\n        <div class="activeDot" *ngIf="i == \'0\' || i == \'4\'"></div>\n      </ion-avatar>\n      <h2 class="nameStyle">{{items.name}}</h2>\n      <p class="paraStyle" text-wrap>{{items.shortSentence}}</p>\n      <ion-badge color="primary" item-end *ngIf="items.badge !== \'0\'">{{items.badgeVal}}</ion-badge>\n    </ion-item>\n  </ion-list>\n  \n</ion-content>\n'/*ion-inline-end:"E:\Animation Project\SimpleChatBot24\SimpleChatBot24\src\pages\chatindex\chatindex.html"*/,
            animations: [
                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["e" /* trigger */])('flyInOut', [
                    Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["b" /* state */])('in', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["c" /* style */])({
                        transform: 'translate3d(0, 0, 0)'
                    })),
                    Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["b" /* state */])('out', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["c" /* style */])({
                        transform: 'translate3d(150%, 0, 0)'
                    })),
                    Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["d" /* transition */])('in => out', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["a" /* animate */])('200ms ease-in')),
                    Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["d" /* transition */])('out => in', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["a" /* animate */])('200ms ease-out'))
                ]),
                Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["d" /* transition */])('* => *', Object(__WEBPACK_IMPORTED_MODULE_3__angular_animations__["a" /* animate */])('.5s'))
            ]
        }),
...
//# sourceMappingURL=chatindex.js.map
